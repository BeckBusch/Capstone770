...
import MyAccountBlack from "../assets/icon-account-black.png";
import MyAccountWhite from "../assets/icon-account-white.png";

function AccountSettingsPage() {
  const { userName, userID, userEmail, userPassword, userRole, userJoined } =
  ...
  return (
    <div className="my-account-page">
      ...
      <div className="my-account-header-container">
        <img
          src={MyAccountBlack}
          className="my-account-icon-align"
          alt="my-account"
        />
